...
class COCOStuffeval:
    ...
    def _accumulateConfusion(self, cocoGt, cocoRes, confusion, imgId):
        ...
        labelMapGt  = cocoSegmentationToSegmentationMap(cocoGt,  imgId, includeCrowd=False).astype(int)
        labelMapRes = cocoSegmentationToSegmentationMap(cocoRes, imgId, includeCrowd=False).astype(int)

        #Janky quick fix, do not try this at home - Harry Liuson
        labelMapRes[labelMapRes == 0] = 183
