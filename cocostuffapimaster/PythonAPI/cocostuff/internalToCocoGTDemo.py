...
def internalToCocoGTDemo(dataType='val2017', dataDir='../..',
    ...
    annPath = '%s/annotations/stuff_%s.json' % (dataDir, dataTypeInst)
    if outputAnnots:
        jsonPath = '%s/annotations/stuff_predict_%s%s.json' % (dataDir, dataType, imgCountStr)
    else:
